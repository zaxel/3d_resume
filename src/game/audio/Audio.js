...
export class Audio {
  constructor(initSettings, riverCurve, camera, keys, controls, audioFiles, scene, musicStatus, soundsStatus, btnsController) {
    this.scene = scene;
    this.camera = camera;
    ...
    this.movementSounds = [this.walkFwdSound, this.runFwdSound, this.walkBwdSound, this.runBwdSound, this.jumpStandSound, this.jumpBwdSound];
    ...
    if (initSettings.blades) {
      ...
      const bladesGroup = this.scene.children.find(child=>child.name === "blade");
  ...
  initHelpBtnsHandler() {
    this.btnsController.onSoundOn = this.btnsController.onSoundOn.bind(null, this.soundOn.bind(this));
    this.btnsController.onSoundOff = this.btnsController.onSoundOff.bind(null, this.soundOff.bind(this));
    this.btnsController.onMusicOn = this.btnsController.onMusicOn.bind(null, this.musicOn.bind(this));
    this.btnsController.onMusicOff = this.btnsController.onMusicOff.bind(null, this.musicOff.bind(this));
  }
  clearMovementSounds() {
  ...
  updateSoundsState() {
    ...
    if (this.camera.position.distanceTo(this.riverSounds.position) > 2) this.updateRiverSound();
